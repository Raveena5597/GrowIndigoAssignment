...
function () {
  ...
  _createClass(AsYouType, [{
    ...
    value: function getFullNumber(formattedNationalNumber) {
      ...
      if (this.isInternational()) {
        var prefix = function prefix(text) {
          return _this2.formatter.getInternationalPrefixBeforeCountryCallingCode(_this2.state.IDDPrefix, {
    ...
    value: function getNumber() {
      ...
      var callingCode = this.getCountryCallingCode() || this.defaultCallingCode; // Google's AsYouType formatter supports sort of an "autocorrection" feature
      ...
      if (!this.isInternational() && nationalSignificantNumber === this.state.digits) {
        var autoCorrected = (0, _AsYouTypeParser.autoCorrectInternationalNumberWithoutPlus)(this.state.digits, countryCode, callingCode, this.metadata);
