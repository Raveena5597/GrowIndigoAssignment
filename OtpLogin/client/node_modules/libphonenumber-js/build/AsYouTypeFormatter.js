...
function () {
  ...
  _createClass(AsYouTypeFormatter, [{
    ...
    value: function getInternationalPrefixBeforeCountryCallingCode(IDDPrefix, options) {
      return IDDPrefix ? options && options.spacing === false ? IDDPrefix : IDDPrefix + ' ' : '+';
    }
  }, {
    key: "getTemplate",
    value: function getTemplate(state) {
      ...
      var index = -1;
      var i = 0;
      var internationalPrefix = state.international ? this.getInternationalPrefixBeforeCountryCallingCode(state.IDDPrefix, {
        spacing: false
      }) : '';
    ...
    value: function setNationalNumberTemplate(template, _ref6) {
      var international = _ref6.international,
          IDDPrefix = _ref6.IDDPrefix,
          callingCode = _ref6.callingCode;
      ...
      if (international) {
        this.template = this.getInternationalPrefixBeforeCountryCallingCode(IDDPrefix).replace(/[\d\+]/g, _AsYouTypeFormatter.DIGIT_PLACEHOLDER) + (0, _AsYouTypeFormatter.repeat)(_AsYouTypeFormatter.DIGIT_PLACEHOLDER, callingCode.length) + ' ' + template;
      } else {
