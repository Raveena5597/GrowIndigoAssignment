...
exports.autoCorrectInternationalNumberWithoutPlus = autoCorrectInternationalNumberWithoutPlus;
...
function autoCorrectInternationalNumberWithoutPlus(digits, countryCode, callingCode, metadata) {
  ...
  var _extractCountryCallin2 = (0, _parse_.extractCountryCallingCodeFromInternationalNumberWithoutPlusSign)(digits, countryCode, callingCode, metadata.metadata),
      newCallingCode = _extractCountryCallin2.countryCallingCode,
      number = _extractCountryCallin2.number;

  if (newCallingCode) {
    return (0, _parse_.extractNationalNumber)(number, metadata);
  }
}
